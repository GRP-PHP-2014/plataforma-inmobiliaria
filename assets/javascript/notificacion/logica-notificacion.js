function loadNotificacionesOnIndex(ns){
    ...
    for (var idx = 0; idx < ns.length; idx++){
        ...
        img.setAttribute("src", "/plataforma-inmobiliaria/images/iconoemail.jpg");
        ...
        var strong = document.createElement("strong");        
        strong.appendChild(document.createTextNode(ns[idx].nombreCliente));
        ...
        small.appendChild(i);
        small.appendChild(document.createTextNode(ns[idx].fechaHoraEnvio));
        if (idx % 2 == 0){
...
<li class="left clearfix">
    <span class="chat-img pull-left">
        <img class="img-circle" src="/plataforma-inmobiliaria/images/iconoemail.jpg">
    </span>
    <div class="chat-body clearfix">
        <div class="header">
