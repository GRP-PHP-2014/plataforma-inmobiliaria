...
<div class="wide form">
    ...
    <div class="form-group col-lg-6">
        ...
        <?php echo $form->textField($model, 'descripcion', array('size' => 60, 'maxlength' => 2048,"class" => "form-control")); ?>
    </div>

    <div class="form-group col-lg-6">
        <?php echo $form->label($model, 'tipo_inmueble'); ?>
        <?php echo $form->textField($model, 'tipo_inmueble', array('size' => 50, 'maxlength' => 50,"class" => "form-control")); ?>
    </div>
